...
#define MAXINODE 50      //  5 its is size of files which we can created 
...
{
   printf("Description : Used to list all informatio of  file \n");
   printf("Usage : lS\n");
}
...
{
    printf("Description :  Used to closef Opend fil \n");
    printf("Usage : close File_name \n");   
}
else if(strcmp(name,"cloeall")==0)
{
    printf("Description : Used to cloall opened  File \n");
...
else if(strcmp(name,"rm")==0)
{
 ...
 printf("ERROR : No manual entry availble \n");
}
...
void DisplayHelp()
{
 printf("To Create File :-- use create --File_Name--1(Read)or  2(Write)  or  3(Read and Write) \n");
 printf("ls    : To List Out all Files \n");
 printf("Clear : To Clear Console\n");
 printf("Open  : To Open the file\n");
 printf("close : To close the file \n");
 printf("Closeall : To Close all opened files \n");
 printf("read  : To read the Contents feom files \n");
 printf("write : To Write Contents from file \n");
 printf("exit  : To terminate  file system");
 printf("stat  : To Display information of file using name \n");
 printf("fstat : To Display information of fle using descriptor \n");
...
/////////////////////////////////////////////////////////////////////////////////
 int main()
 {
    ...
    while(1)
    {
     fflush(stdin);        //   for InputBuffer Washer   it is like (" %s") 
     strcpy(str,"");       
  ...
  {
    printf("Terminiting the Marvellous Virstual File System\n");
    break;
  }
  else{
   ...
   ret = truncate_File(command[1]);
    ...
    else if(count == 3)
    {
      ...
      else if(strcmp(command[0],"read")==0)
      {
       ...
       if(fd == -1)
       {
        printf("ERROR : Incorrect paarameter \n");
        continue;
       }
      ...
      printf("ERROR : permission denied \n");
      if(ret == -3)
        printf("ERRORR : Reached at end of file \n");
      if(ret == -4)
        printf("ERROR : It is Not regular file \n");
      if(ret == 0)
    ...
    else if(count == 4)
    {
      if(strcmp(command[0],"lseek")==0)
      {
        ...
        ret = LseekFile(fd,atoi(command[0]),atoi(command[3]));
        if(ret == -1)
        {
